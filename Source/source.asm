...
#################################################################################################	
	...
	# li $t4, 0
	# print_outer_loop:
	# 	beq $t4, $t3, end_print_outer_loop
	...
	# 	li $t5, 0
	# 	print_inner_loop:
	# 		beq $t5, $t3, end_print_inner_loop
...
convolve:
	...
	# li $t5, 0
	# print_output_loop_1:
	# 	beq $t5, $t4, end_print_output_loop1
...
positive:
	...
	sub.s $f2, $f2, $f0	# f12 is now the decimal part, we only need the first two digits
